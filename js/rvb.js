...
var g_url_img_vide = "../img/blank.gif";
    ...
    PaletteCouleurs.prototype.afficher = function() {
        ...
        if (this.erreur) this.afficherErreur();
            ...
            if (this.erreur) this.afficherErreur();
                ...
                html += "<br><br><br><br>logo<br><img src='../img/logorvb.png' border=1></div>";
                document.write(html);
            }
        }
    }
...
function InterfaceCouleurs() {
    this.opener_form = 'f1';// form;//'f1';   // modifié openMairie
    ...
    InterfaceCouleurs.prototype.afficher = function(retour) {
        ...
        var largBoiteRVB = 10+"px";
        var largBoiteCode = 8+"px";
        ...
        html += "<div>Composantes RVB<br> R <input type='text' name='rouge' size=" + largBoiteRVB + " value='' class='inputr'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        html += "<div>V <input type='text' name='vert' size=" + largBoiteRVB + " value='' class='inputv'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        html += "<div>B <input type='text' name='bleu' size=" + largBoiteRVB + " value='' class='inputb'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        // la boîte indiquant le code couleur de la couleur sélectionnée
        html += "<div> Hexadecimal <input type='text' style='background-color:#ffffff;color:#A7A8B1' name='code_couleur' size=" + largBoiteCode + " value=''";
        html += " onchange='ui.codeCouleurEnRVB()' /></div>";
        // la case témoin couleur de survol
        html += "<div id='temoin_survol' style='background-color:#ffffff;color:#ffffff;font-weight:bold'>";
        html += "Couleur Survolée <img src='" + g_url_img_vide + "' width='50' height='35' border='0' /></div>";
        // la case témoin de la couleur sélectionnée
        html += "<div id='temoin' style='background-color:#ffffff;color:#ffffff;font-weight:bold'>";
    ...
    InterfaceCouleurs.prototype.envoyerCouleur = function() {
        ...
        if (this.couleur == null) alerte("Aucune couleur n'a été sélectionnée.");
            ...
            if (this.controlerCodeCouleur() && this.controlerComposantes()) {
                ...
                // retour couleur RVB
                selec_couleur = document.forms['selec_couleur'];
