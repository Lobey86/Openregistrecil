 ...
 * @version SVN : $Id: password.php 283 2010-11-30 10:25:24Z fmichon $
 */
...
//
echo "<ul>";
echo "<li><a href=\"#tabs-1\">"._("Mot de passe")."</a></li>";
echo "</ul>\n";
...
echo "<input type=\"submit\" name=\"submit-change-password\" value=\""._("Valider")."\" class=\"boutonFormulaire\" />";
echo "</div>\n";
//
echo "</form>\n";
echo "</div>\n";
